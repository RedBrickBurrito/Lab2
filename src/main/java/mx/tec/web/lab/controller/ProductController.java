...
public class ProductController {
	 ...
	 * 
	 * @param id Product id
	 * @return a json containing the product info and status 200 if the product is
	 *         found or status 204 if the product is not found
	 */
	 ...
	 * @return If the product is created successfully then status 201 and the
	 *         product info is returned, otherwise it returns status 400
	 */
	 ...
	 * @return status 200 if the product is found and updated or status 204 if the
	 ...
	 * 
	 * @param id Product id
	 * @return status 200 if the product is found and deleted or status 204 if the
	 *         product is not found
	 */
